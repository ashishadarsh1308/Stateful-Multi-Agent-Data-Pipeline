...
#-------------------------- Prompt Query Context Generation code --------------------------
...
# Cancel the execution of the SQL query if it is not safe
...
# Execute the SQL query if it is safe
...
# represent the final answer based on the SQL query execution result and the curated question
...
if __name__ == "__main__":
    ...
    input_schema = {
        "messages": [],
        "user_question": "put null to all the records in the column 'email' of the table 'users' in the database",
        "curated_ques": "",
    ...
    #print final answer
    print(sql_analyst_response['final_answer'])  # Print the final answer generated by the agent